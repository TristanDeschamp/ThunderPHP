...
class Thunder
{
	...
	/**
   * Main function to create plugins, migrations, and models
   *
   * @param array $args
   */
	public function make(array $args)
	{
		...
		if($action == 'make:plugin')
		{
			...
			/* Create main plugin folder and subdirectories */
			...
			/* Copy samples files to the new plugin folder */
	...
	/**
   * Function to migrate or rollback migrations
   *
   * @param array $args
   */
